...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'UltimasNoticias'
        db.create_table(u'portlet_ultimasnoticias', (
            (u'portlet_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['slot.Portlet'], unique=True, primary_key=True)),
            ('numero', self.gf('django.db.models.fields.PositiveIntegerField')(default=5)),
        ))
        db.send_create_signal(u'portlet', ['UltimasNoticias'])

        # Adding model 'Noticia'
        db.create_table(u'portlet_noticia', (
            (u'portlet_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['slot.Portlet'], unique=True, primary_key=True)),
            ('simplenews', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['simplenews.SimpleNews'], unique=True)),
        ))
        db.send_create_signal(u'portlet', ['Noticia'])

        # Adding model 'Basico'
        db.create_table(u'portlet_basico', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('titulo', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('imagem', self.gf('django.db.models.fields.files.ImageField')(max_length=100)),
            ('imagem_posicao', self.gf('django.db.models.fields.CharField')(max_length=5, blank=True)),
            ('texto', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal(u'portlet', ['Basico'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'UltimasNoticias'
        db.delete_table(u'portlet_ultimasnoticias')

        # Deleting model 'Noticia'
        db.delete_table(u'portlet_noticia')

        # Deleting model 'Basico'
        db.delete_table(u'portlet_basico')
